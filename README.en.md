...
- **Practice history**: Past sessions and overall stats; open a **review page** from practice history or the latest-practice cards on Home to revisit that attempt's answers, marked questions, and highlight positions; **export** data to a file for backup or **import** a file to restore on this device (e.g. new computer or recovery).
...
- **Interface**: **Chinese or English** UI; **light and dark** themes to reduce eye strain during long reading sessions; Responsive layout for mainstream desktops, tablets, and phones; **PWA** support—install as an app, add to desktop or home screen, and launch from the desktop like a native app.
